...
- (void)selectSubviewsWithUserMode:(NTESUserMode)userMode {
    switch (userMode) {
        case NTESUserModeAnchor:
            self.cacheSubviews = @[self.exitButton,self.voiceButton,self.micMuteButton,self.noSpeakingButton];
            break;
        case NTESUserModeAudience:
            self.cacheSubviews = @[self.exitButton,self.voiceButton];
            break;
        case NTESUserModeConnector:
            self.cacheSubviews = @[self.exitButton,self.dropMicButton, self.voiceButton,self.micMuteButton];
            break;
        default:
            break;
    }
