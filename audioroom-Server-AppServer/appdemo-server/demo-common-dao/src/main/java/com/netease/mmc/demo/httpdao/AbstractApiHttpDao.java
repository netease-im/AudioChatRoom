...
public abstract class AbstractApiHttpDao {
    ...
    @CheckForNull
    @Nullable
    private String postFormData(@Nonnull String path, @Nonnull final MultiValueMap params, @Nonnull String appKey, @Nonnull String appSecret) {
        // set headers
    ...
    @CheckForNull
    @Nullable
    private String postJsonData(@Nonnull String path, @Nonnull Object params, @Nonnull String appKey, @Nonnull String appSecret) {
        // set headers
        HttpHeaders headers = new HttpHeaders();
        setAuthenticationHeaders(headers, appKey, appSecret);
