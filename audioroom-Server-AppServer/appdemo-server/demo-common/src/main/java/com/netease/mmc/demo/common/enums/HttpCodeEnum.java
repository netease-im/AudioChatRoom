...
public enum HttpCodeEnum {
     ...
     * {@code 601 直播间正在使用中}
     */
    ROOM_USING(601, "房间正在使用中"),
    /**
     * {@code 610 无可用频道}
     */
    ROOM_NOT_ENOUGH(610, "无可用频道"),

    /*7xx 点播相关错误码*/
    /**
     * {@code 700 点播请求失败}
     */
    VOD_ERROR(700, "点播请求失败"),
    /**
     * {@code 701 点播视频存在}
     */
    VOD_VIDEO_ALREADY_EXISTS(701, "视频已上传"),
    /**
     * {@code 702 点播视频未上传}
     */
    VOD_VIDEO_NOT_UPLOADED(702, "视频未上传"),
    /**
     * {@code 704 点播视频不存在}
     */
    VOD_VIDEO_NOT_FOUND(704, "视频不存在"),
    /**
     * {@code 705 点播转码视频不存在}
     */
    VOD_TRANSVIDEO_NOT_FOUND(705, "转码视频不存在"),
    
    /**
     * {@code 706 添加点播视频太频繁}
     */
    VOD_VIDEO_ADD_FREQUENCY(706, "添加点播视频太频繁"),
